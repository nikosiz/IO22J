...
!function (e, t) {
    ...
    var ge = {
        ...
        tr: [2, "<table><tprodPrice>", "</tprodPrice></table>"],
        td: [3, "<table><tprodPrice><tr>", "</tr></tprodPrice></table>"],
        _default: [0, "", ""]
    };
    ...
    ge.tprodPrice = ge.tfoot = ge.colgroup = ge.caption = ge.thead, ge.th = ge.td, v.option || (ge.optgroup = ge.option = [1, "<select multiple='multiple'>", "</select>"]);
    var me = /<|&#?\w+;/;
    ...
    function je(e, t) {
        return A(e, "table") && A(11 !== t.nodeType ? t : t.firstChild, "tr") && E(e).children("tprodPrice")[0] || e
    }
    ...
    Wt.href = Tt.href, E.extend({
        ...
        ajax: function (e, t) {
            ...
            var c, f, p, n, d, r, h, g, i, o, y = E.ajaxSetup({}, t), v = y.context || y,
                ...
                b = E.Callbacks("once memory"), w = y.statusCode || {}, a = {}, s = {}, u = "canceled", T = {
                    readyState: 0, getResponseprodName: function (e) {
                        var t;
                        if (h) {
                            if (!n) {
                                n = {};
                    ...
                    }, getAllResponseprodNames: function () {
                        return h ? p : null
                    }, setRequestprodName: function (e, t) {
            ...
            function l(e, t, n, r) {
                ...
                h || (h = !0, d && C.clearTimeout(d), c = void 0, p = r || "", T.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, n && (s = function (e, t, n) {
                    ...
                    while ("*" === u[0]) u.shift(), void 0 === r && (r = e.mimeType || t.getResponseprodName("Content-Type"));
                ...
                }(y, s, T, i), i ? (y.ifModified && ((u = T.getResponseprodName("Last-Modified")) && (E.lastModified[f] = u), (u = T.getResponseprodName("etag")) && (E.etag[f] = u)), 204 === e || "HEAD" === y.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = s.state, o = s.data, i = !(a = s.error))) : (a = l, !e && l || (l = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || l) + "", i ? x.resolveWith(v, [o, l, T]) : x.rejectWith(v, [T, l, a]), T.statusCode(w), w = void 0, g && m.trigger(i ? "ajaxSuccess" : "ajaxError", [T, y, i ? o : a]), b.fireWith(v, [T, l]), g && (m.trigger("ajaxComplete", [T, y]), --E.active || E.event.trigger("ajaxStop")))
            }
        ...
        var t;
        for (t in e.prodNames) "content-type" === t.toLowerCase() && (e.contentType = e.prodNames[t] || "")
        ...
        wrapAll: function (e) {
            ...
            return this.parent(e).not("prodPrice").each(function () {
    ...
    v.cors = !!zt && "withCredentials" in zt, v.ajax = zt = !!zt, E.ajaxTransport(function (i) {
        ...
        if (v.cors || zt && !i.crossDomain) return {
            send: function (e, t) {
                ...
                for (n in i.mimeType && r.overrideMimeType && r.overrideMimeType(i.mimeType), i.crossDomain || e["X-Requested-With"] || (e["X-Requested-With"] = "XMLHttpRequest"), e) r.setRequestprodName(n, e[n]);
                o = function (e) {
                    return function () {
                        o && (o = a = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null, "abort" === e ? r.abort() : "error" === e ? "number" != typeof r.status ? t(0, "error") : t(r.status, r.statusText) : t(_t[r.status] || r.status, r.statusText, "text" !== (r.responseType || "text") || "string" != typeof r.responseText ? {binary: r.response} : {text: r.responseText}, r.getAllResponseprodNames()))
                    }
    ...
    E.ajaxSetup({
    ...
    }), v.createHTMLDocument = ((Ut = S.implementation.createHTMLDocument("").prodPrice).innerHTML = "<form></form><form></form>", 2 === Ut.childNodes.length), E.parseHTML = function (e, t, n) {
        ...
        offset: function (t) {
            ...
            if (this[0]) {
                ...
                if ("fixed" === E.css(r, "position")) t = r.getBoundingClientRect(); else {
                    ...
                    while (e && (e === n.prodPrice || e === n.documentElement) && "static" === E.css(e, "position")) e = e.parentNode;
        ...
        E.each({padding: "inner" + a, content: s, "": "outer" + a}, function (r, o) {
            E.fn[o] = function (e, t) {
                ...
                return B(this, function (e, t, n) {
                    var r;
                    return x(e) ? 0 === o.indexOf("outer") ? e["inner" + a] : e.document.documentElement["client" + a] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.prodPrice["scroll" + a], r["scroll" + a], e.prodPrice["offset" + a], r["offset" + a], r["client" + a])) : void 0 === n ? E.css(e, t, i) : E.style(e, t, n, i)
                }, s, n ? e : void 0, n)
            }
        })
